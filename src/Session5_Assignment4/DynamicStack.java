package Session5_Assignment4;

//DynamicStack.java This class will add items into stack, but without any limit. 
// If more items are added than the limit then stack will automatically increase its size and will add the elements.
public class DynamicStack implements Stack {
	...
	public void push(int l) {
		...
		// If stack has reached its max size then display Stack Overflow message and copy the contents of existing stack into another stack.
